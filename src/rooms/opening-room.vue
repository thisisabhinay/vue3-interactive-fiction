...
<template>
  <section id="SceneIntro">
    <SceneRoom1_0 />
    <InteractionDescription text="Look at: The Blurred World">
    ...
    />
    <StoryChoice
      label="'Who are you?'': (Seek information on the voice and this place)"
      :scene="SceneRoom1_2"
    />
    <StoryChoice
      label="Focus on the voice: (Try to discern a location or source)"
      :scene="SceneRoom1_3"
    />
  </section>
</template>
